  ...
  <div class="row mt-4">
    <div class="col-md-2 mt-2 pr-3 pt-4 bg-secondary">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php"><i class="fas fa-users"></i> Daftar Buku</a>
          <hr>
        </li>
        <li class="nav-item">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class="fas fa-users"></i> Data Peminjam Buku</h3>
      <hr>

      <ul class="list-group">
        <li class="list-group-item active">Nama Buku : <?= $camaba['nama buku']; ?></li>
        <li class="list-group-item">Nama Pengarang : <?= $camaba['nama pengarang']; ?></li>
        <li class="list-group-item">Penerbit : <?= $camaba['penerbit']; ?></li>
        <li class="list-group-item">Nama Perpustakaan : <?= $camaba['nama perpustakaan']; ?></li>
        <li class="list-group-item">Instansi : <?= $camaba['sekolah_asal']; ?></li>
