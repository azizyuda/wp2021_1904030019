...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class="fas fa-users"></i> Input Anggota</h3>
      <hr>
      ...
      <form method="POST" action="">
        ...
        <div class="form-group">
          <label for="nama buku">Nama_Buku : </label>
          <input type="text" class="form-control" id="nama buku" value="<?= $camaba['nama buku'] ?>" placeholder="nama buku" name="nama buku" autofocus required autocomplete="off">
        </div>
        <div class="form-group">
          <label for="nama pengarang">Nama_Pengarang : </label>
          <input type="text" class="form-control" id="nama pengarang" value="<?= $camaba['nama pengarang'] ?>" placeholder="nama pengarang" name="nama pengarang" required autocomplete="off">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="nama perpustakaan">Nama_Perpustakaan : </label>
          <input type="text" class="form-control" id="nama perpustakaan" value="<?= $camaba['nama perpustakaan'] ?>" placeholder="nama perpustakaan" name="nama perpustakaan" required autocomplete="off">
        </div>
        <div class="form-group">
