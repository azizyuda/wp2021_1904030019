...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class="fas fa-users"></i> Table Buku Mata Unta</h3>
      <hr>
        ...
        <tbody>
          ...
          <?php foreach ($camaba as $cmb) : ?>
            <tr>
              ...
              <td><?php echo $cmb['nama buku']; ?></td>
              <td><?php echo $cmb['nama pengarang']; ?></td>
              <td><?php echo $cmb['penerbit']; ?></td>
              <td><?php echo $cmb['nama perpustakaan']; ?></td>
              <td><?php echo $cmb['sekolah_asal']; ?></td>
              <td><a href="detail.php?id=<?= $cmb['id']; ?>" class="btn btn-warning" role="button">detail</a></td>
              <td><a href="edit.php?id=<?= $cmb['id']; ?>" class="btn btn-warning" role="button">edit</a></td>
              <td><a href="hapus.php?id=<?= $cmb['id']; ?>" class="btn btn-warning" role="button">hapus</a></td>
            </tr>
            <?php $no++ ?>
          <?php endforeach ?>
        </tbody>
